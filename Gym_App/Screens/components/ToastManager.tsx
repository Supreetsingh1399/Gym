    ...
    success: (props: ToastProps) => (
      <View className="mb-5 px-6 py-4 bg-green-100 border-l-4 border-green-600 shadow-lg rounded-lg min-w-[250px] max-w-[90%] mx-4">
        <View className="flex-row items-center">
          ...
          <Text className="ml-2 font-bold text-green-800">
            {props.text1 || "Default Success Message"}
          </Text>
        </View>
        {props.text2 && (
          <Text className="ml-8 text-sm text-green-700 mt-1">
            {props.text2}
          </Text>
        )}
      </View>
    ...
    error: (props: ToastProps) => (
      <View className="mb-5 px-6 py-4 bg-red-100 border-l-4 border-red-600 shadow-lg rounded-lg min-w-[250px] max-w-[90%] mx-4">
        <View className="flex-row items-center">
          ...
          <Text className="ml-2 font-bold text-red-800">
            {props.text1 || "Default Error Message"}
          </Text>
        </View>
        {props.text2 && (
      ...
      <View className="mb-5 px-6 py-4 bg-blue-100 border-l-4 border-blue-600 shadow-lg rounded-lg min-w-[250px] max-w-[90%] mx-4">
        <View className="flex-row items-center">
          ...
          <Text className="ml-2 font-bold text-blue-800">
            {props.text1 || "Default Info Message"}
          </Text>
        </View>
        {props.text2 && (
      ...
      <View className="mb-5 px-6 py-4 bg-yellow-100 border-l-4 border-yellow-600 shadow-lg rounded-lg min-w-[250px] max-w-[90%] mx-4">
        <View className="flex-row items-center">
          ...
          <Text className="ml-2 font-bold text-yellow-800">
            {props.text1 || "Default Warning Message"}
          </Text>
        </View>
        {props.text2 && (
          <Text className="ml-8 text-sm text-yellow-700 mt-1">
            {props.text2}
          </Text>
        )}
      </View>
    ...
    location: (props: ToastProps) => (
      <View className="mb-5 px-6 py-4 bg-indigo-100 border-l-4 border-indigo-600 shadow-lg rounded-lg min-w-[250px] max-w-[90%] mx-4">
        <View className="flex-row items-center">
          ...
          <Text className="ml-2 font-bold text-indigo-800">
            {props.text1 || "Default Location Message"}
          </Text>
        </View>
        {props.text2 && (
          <Text className="ml-8 text-sm text-indigo-700 mt-1">
            {props.text2}
          </Text>
        )}
      </View>
