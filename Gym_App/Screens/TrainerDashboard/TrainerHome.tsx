          ...
          <View className="bg-white p-4 rounded-xl shadow-sm">
            <View className="flex-row items-center mb-4">
              ...
              <Text className="text-gray-800">
                Account Status: <Text className="font-medium">Active</Text>
              </Text>
            </View>
        ...
        <View className="px-6 mb-6">
          <View className="bg-blue-50 p-4 rounded-xl border border-blue-100">
            ...
            <Text className="text-sm text-blue-700">
              We're working on new features for trainers including client
              management, workout planning, and progress tracking tools.
            </Text>
          </View>
        </View>
      </ScrollView>
