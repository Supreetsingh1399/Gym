...
const US_SignUp = ({ navigation }: ScreenProps<'UserRegister'>): JSX.Element => {
  // Form state
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      try {
        ...
        const mongoResponse = await axios.post(`${API_URL}/Register/Users`, userDataObj, {
          headers: {
        ...
        console.error("MongoDB API error:", mongoError);
        // Continue even if MongoDB fails
      }
      
      // 2. Also try the regular API as a backup
      if (!mongoDbSaved) {
        try {
          console.log("Trying backup API endpoint...");
          await axios.post(`${API_URL}/Register/Users`, userDataObj);
          console.log("User data sent to backup API successfully");
        } catch (apiError) {
        ...
        return (
          ...
          <Animated.View style={[styles.stepContainer, animatedContainerStyle]}>
            ...
            <View style={styles.inputContainer}>
              ...
              {errors.phoneNumber ? <Text style={styles.errorMessage}>{errors.phoneNumber}</Text> : null}
            </View>
          </Animated.View>
        );
          ...
          <Animated.View style={[styles.stepContainer, animatedContainerStyle]}>
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.selectionContainer}>
                {['Weight Loss', 'Muscle Building', 'Endurance', 'General Fitness'].map((goal) => (
                  <TouchableOpacity
                    key={goal}
                    style={[
                      styles.selectionOption,
                      userData.fitnessGoal === goal ? styles.selectionActive : null
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        ...
                        userData.fitnessGoal === goal ? styles.selectionTextActive : null
                      ]}
                    >
                      {goal}
                    </Text>
              ...
              {errors.fitnessGoal ? <Text style={styles.errorMessage}>{errors.fitnessGoal}</Text> : null}
            </View>
              ...
              <View style={styles.genderContainer}>
                {['Male', 'Female', 'Other'].map((gender) => (
                  ...
                  >
                    <View style={styles.iconContainer}>
                      <Ionicons 
                        name={gender === 'Male' ? 'male-outline' : gender === 'Female' ? 'female-outline' : 'person-outline'} 
                        size={22} 
                    ...
                    <Text
                      style={[
                        styles.genderText,
                        userData.gender === gender ? styles.genderTextActive : null
                      ]}
                    >
                      {gender}
                    </Text>
            ...
            <View style={styles.inputContainer}>
              ...
              {errors.dateOfBirth ? <Text style={styles.errorMessage}>{errors.dateOfBirth}</Text> : null}
            </View>
            ...
            <View style={styles.rowContainer}>
              <View style={[styles.inputContainer, { flex: 1, marginRight: 8 }]}>
                ...
                {errors.weight ? <Text style={styles.errorMessage}>{errors.weight}</Text> : null}
              </View>
              ...
              <View style={[styles.inputContainer, { flex: 1, marginLeft: 8 }]}>
                ...
                {errors.height ? <Text style={styles.errorMessage}>{errors.height}</Text> : null}
              </View>
            </View>
          </Animated.View>
        );
        ...
        return (
          ...
          <Animated.View style={[styles.stepContainer, animatedContainerStyle]}>
            ...
            <Text style={styles.stepDescription}>
              Choose a secure password that you'll remember. We recommend using a combination of letters, numbers, and special characters.
            </Text>
                ...
                <View 
                  style={[
                    ...
                    { 
                      ...
                      backgroundColor: password.length < 4 ? '#ff4d4d' : password.length < 6 ? '#ffbb33' : password.length < 10 ? '#44cc44' : '#00aaff'
                    }
                  ]} 
                />
              </View>
            ...
            <View style={styles.verificationNote}>
              ...
              <Text style={styles.noteText}>
                A verification email will be sent to your email address. Please verify your email to complete the registration process.
              </Text>
            </View>
      ...
      <View style={styles.progressContainer}>
        {Array.from({ length: totalSteps }, (_, index) => (
          <View 
            ...
            style={[
              styles.progressBar,
              index < currentStep ? styles.progressComplete : styles.progressIncomplete
            ]}
          />
        ))}
      </View>
