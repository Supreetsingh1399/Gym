...
const TR_SignUp = ({ navigation }) => {
  ...
  const [TrainerData, setTrainerData] = useState({
    ...
    gymName: "", gymAddress: "", gymCity: "", gymState: "",
    gymPhone: "", gymEmail: "", gymWebsite: ""
  });
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        {step === 1 ? (
          <View>
            <Text className="text-2xl font-bold text-center mb-6">Personal Details</Text>
            <TextInput
              className={inputStyle}
              placeholder="Email"
              value={TrainerData.email}
              onChangeText={text => setTrainerData({...TrainerData, email: text})}
            ...
            <TextInput
              ...
              onChangeText={text => setTrainerData({...TrainerData, password: text})}
              secureTextEntry
            />
            <TextInput
              className={inputStyle}
              ...
              onChangeText={text => setTrainerData({...TrainerData, name: text})}
            />
            <TextInput
              className={inputStyle}
              placeholder="Phone"
              value={TrainerData.phone}
              onChangeText={text => setTrainerData({...TrainerData, phone: text})}
          ...
          <View>
            <Text className="text-2xl font-bold text-center mb-6">Gym Details</Text>
            <TextInput
              className={inputStyle}
              placeholder="Gym Name"
              value={TrainerData.gymName}
              onChangeText={text => setTrainerData({...TrainerData, gymName: text})}
            />
            <TextInput
              className={inputStyle}
              placeholder="Gym Address"
              value={TrainerData.gymAddress}
              onChangeText={text => setTrainerData({...TrainerData, gymAddress: text})}
            />
            <TextInput
              className={inputStyle}
              placeholder="City"
              value={TrainerData.gymCity}
              onChangeText={text => setTrainerData({...TrainerData, gymCity: text})}
            />
            <TextInput
              className={inputStyle}
              placeholder="State"
              value={TrainerData.gymState}
              onChangeText={text => setTrainerData({...TrainerData, gymState: text})} 
            />
            <TextInput
              className={inputStyle}
              placeholder="Gym Phone"
              value={TrainerData.gymPhone}
              onChangeText={text => setTrainerData({...TrainerData, gymPhone: text})}
              keyboardType="phone-pad"
            />
            <TextInput
              className={inputStyle}
              ...
              onChangeText={text => setTrainerData({...TrainerData, gymEmail: text})}
              keyboardType="email-address"
              autoCapitalize="none"
            />
            <TextInput
              ...
              onChangeText={text => setTrainerData({...TrainerData, gymWebsite: text})}
              autoCapitalize="none"
            />
