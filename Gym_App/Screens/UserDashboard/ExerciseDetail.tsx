  ...
  if (!exercise) {
    return (
      <SafeAreaView className="flex-1 bg-gray-50 justify-center items-center">
        ...
        <Text className="mt-4 text-gray-800 font-bold text-lg">Exercise Not Found</Text>
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View className="flex-row mt-2 flex-wrap">
            ...
            <View className="bg-green-50 px-3 py-1 rounded-full mr-2 mb-2">
              <Text className="text-green-600 font-medium">
                <Ionicons name="fitness-outline" size={14} /> {exercise.equipment}
              </Text>
            </View>
            
            <View className="bg-orange-50 px-3 py-1 rounded-full mr-2 mb-2">
              <Text className="text-orange-600 font-medium">
                <Ionicons name="stats-chart-outline" size={14} /> {exercise.difficulty}
              </Text>
            </View>
          </View>
        ...
        <View className="mt-6 px-4">
          <Text className="text-gray-800 font-bold text-lg mb-2">Tips & Advice</Text>
          
          <View className="bg-white rounded-xl p-4 shadow-sm">
            <View className="flex-row items-start mb-3">
              <Ionicons name="checkmark-circle" size={20} color={THEME.colors.green} style={{ marginTop: 2 }} />
              <Text className="text-gray-700 ml-2 flex-1">
                Focus on proper form rather than lifting heavy weights or doing many reps.
              </Text>
            </View>
            ...
            <View className="flex-row items-start">
              <Ionicons name="checkmark-circle" size={20} color={THEME.colors.green} style={{ marginTop: 2 }} />
              <Text className="text-gray-700 ml-2 flex-1">
                If you feel pain (not just muscle fatigue), stop immediately to avoid injury.
              </Text>
            </View>
          </View>
        </View>
        ...
        <View className="mt-6 px-4">
          <Text className="text-gray-800 font-bold text-lg mb-2">Recommended Sets & Reps</Text>
