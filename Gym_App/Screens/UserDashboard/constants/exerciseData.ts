...
export const POPULAR_WORKOUTS: WorkoutData[] = [
  {
    ...
    description:
      "Complete full body workout focusing on compound movements for strength development",
    category: "Strength",
    calories: "350-450",
    exercises: [
  ...
  },
  {
    ...
    trainer: "Mike Torres",
    description:
      "Focus on core strength with effective ab exercises for a stronger midsection",
    category: "Core",
    calories: "200-300",
    exercises: [
      EXERCISES[3], // Plank
  ...
  },
  {
    ...
    trainer: "David Kim",
    description:
      "Build strength in arms, chest, back and shoulders with this targeted upper body workout",
    category: "Strength",
    calories: "300-400",
    exercises: [
      EXERCISES[0], // Push-ups
  ...
  },
  {
    ...
    trainer: "Lisa Wong",
    description:
      "Perfect for beginners or those without equipment, using just your bodyweight for a total body workout",
    category: "Strength",
    calories: "250-350",
    exercises: [
      EXERCISES[0], // Push-ups
  ...
  },
  {
    ...
    description:
      "Build strength and power in your legs with this intense lower body workout",
    category: "Strength",
    calories: "350-450",
    exercises: [
      EXERCISES[1], // Squats
...
export const getRelatedWorkouts = (
  currentWorkoutId: string,
  count = 3,
): WorkoutData[] => {
  return POPULAR_WORKOUTS.filter((workout) => workout.id !== currentWorkoutId)
...
export const getWorkoutsByLevel = (level: string): WorkoutData[] => {
  return POPULAR_WORKOUTS.filter(
    (workout) => workout.level.toLowerCase() === level.toLowerCase(),
  );
};
...
export const getWorkoutsByCategory = (category: string): WorkoutData[] => {
  return POPULAR_WORKOUTS.filter(
    (workout) => workout.category.toLowerCase() === category.toLowerCase(),
  );
};
