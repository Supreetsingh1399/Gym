  ...
  if (!workout) {
    return (
      <SafeAreaView className="flex-1 bg-gray-50 justify-center items-center">
        ...
        <Text className="mt-4 text-gray-800 font-bold text-lg">Workout Not Found</Text>
        ...
        <View className="bg-white p-4 shadow-sm">
          <View className="flex-row justify-between">
            <View className="flex-1 items-center p-2">
              ...
              <Text className="text-gray-800 font-bold">{workout.duration}</Text>
            </View>
            ...
            <View className="flex-1 items-center p-2">
              ...
              <Text className="text-gray-800 font-bold">{workout.calories || "300-400"}</Text>
            </View>
          </View>
...
<View className="mt-4 px-4">
  ...
  {workout.exercises && workout.exercises.length > 0 ? (
    ...
    <View className="bg-white rounded-xl p-6 items-center">
      ...
      <Text className="text-gray-800 font-bold mt-2">No Exercises Found</Text>
      <Text className="text-gray-500 text-center mt-1">
        ...
        <View className="mt-6 px-4">
          <Text className="text-gray-800 font-bold text-lg mb-2">How to Use This Workout</Text>
          ...
          <View className="bg-white rounded-xl p-4 shadow-sm">
            ...
            <View className="flex-row items-start mb-3">
              ...
              <Text className="text-gray-700 ml-2 flex-1">
                For each exercise, do 3 sets of 12-15 reps, resting 30-60 seconds between sets.
              </Text>
            </View>
            ...
            <View className="flex-row items-start">
              ...
              <Text className="text-gray-700 ml-2 flex-1">
                Rest 1-2 minutes between different exercises. Take longer rest periods as needed.
              </Text>
            </View>
          </View>
        </View>
