  ...
  const handleResetPassword = async (): Promise<void> => {
    ...
    try {
      ...
      if (error.code === "auth/invalid-email") {
        ...
        errorMessage =
          "We were unable to process your request. Please check your email and try again.";
      }
      ...
      >
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.infoText}>
            For security reasons, we'll send a reset link only if the email is
            registered.
          </Text>
        </View>
